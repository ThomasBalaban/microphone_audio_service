"""
Minimal HTTP control server for the Microphone Audio Service.
GET  /health   → {"status": "ok"}
POST /shutdown → triggers clean shutdown
"""
...
def start(shutdown_callback):
    ...
    t.start()
    print(f"✅ [MicHTTP] Health server on :{HTTP_CONTROL_PORT} (/health, /shutdown)")
